// Copy from https://github.com/samhirtarif/react-audio-recorder/blob/master/src/hooks/useAudioRecorder.ts
// Some modifications were made to adapt to the project
...
export interface UseAudioRecorderHook {
...
}: UseAudioRecorderHook = {}): RecorderControls {
